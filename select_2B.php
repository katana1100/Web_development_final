...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">客戶之貸款總金額查詢</li>
        </ol>
    </nav>
    <center>
        <h2>客戶之貸款總金額查詢</h2>
...
// sql語法存在變數中
$sql = "SELECT SUM(LP_total) AS 貸款總和,SUM(LP_repay_per_year) AS 每年還款 FROM Final_S07352026.LOAN_CLIENT AS C WHERE LP_C_name='$name'";
