...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">客戶於特定分行之貸款資訊查詢</li>
        </ol>
    </nav>
    <center>
        <h2>客戶於特定分行之貸款資訊查詢</h2>
...
// sql語法存在變數中
$sql = "SELECT B_manager AS 分行經理,SUM(LP_total) AS 貸款總和,SUM(LP_repay_per_year) AS 每年還款 FROM Final_S07352026.BANK AS B, Final_S07352026.LOAN_CLIENT AS C WHERE LP_C_name='$Cname' AND LP_B_name = '$Bname' AND B_name = '$Bname'";
...
?> </div>
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    分行經理：<?php echo $row['分行經理'];
                    ?> </li>
                <li class="list-group-item">貸款總額： <?php echo $row['貸款總和'];
?> 元</li>
