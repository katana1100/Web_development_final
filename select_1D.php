...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">特定貸款計畫之總金額查詢</li>
        </ol>
    </nav>
    <center>
        <h2>特定貸款計畫之總金額查詢</h2>
...
// sql語法存在變數中
$sql = "SELECT SUM(LP_total) AS 貸款總額, SUM(LP_repay_per_year) AS 每年還款 FROM Final_S07352026.LOAN_CLIENT WHERE LP_P_name='$name'";
...
?> </div>
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    已貸出總額：<?php echo $row['貸款總額'];
                    ?> 元 </li>
                <li class="list-group-item">客戶每年還款總額： <?php echo $row['每年還款'];
?> 元</li>
                <?php endforeach;
?>
                <?php endif;
